...
<template>
    <scroll-view scroll-y class="scroll-view" @scrolltolower="onScrolltolower">
        ...
        <template v-if="memberStore.profile">
            ...
            <view class="cart-list" v-if="cartList.length">
                ...
                <uni-swipe-action>
                    ...
                    <uni-swipe-action-item v-for="item in cartList" :key="item.skuId" class="cart-swipe">
                        ...
                        <view class="goods">
                            <!-- 选中状态 -->
                            <text class="checkbox" @tap="onChangeSelected(item)"
            ...
            <!-- 吸底工具栏 -->
            <view class="toolbar" :style="{ paddingBottom: query.paddingBottom + 'px' }">
                <text class="all" @tap="onChangeSelectedAll" :class="{ checked: isSelectedAll }">全选</text>
                <text class="text">合计:</text>
                <text class="amount">{{ selectedCartListMoney }}</text>
                <view class="button-grounp">
                    <view class="button payment-button" @tap="gotoPayment"
